...
var OutlinedInput = React8.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime9.jsx)(InputBase_default, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime9.jsx)(NotchedOutlineRoot2, {
      ...
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime8.jsxs)(React8.Fragment, {
        children: [label, " ", "*"]
      })) : label,
...
var FormLabel = React9.forwardRef(function FormLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime10.jsxs)(FormLabelRoot, _extends({
    as: component,
    ownerState,
    className: clsx_default(classes.root, className),
    ref
  }, other, {
    children: [children, fcs.required && (0, import_jsx_runtime10.jsxs)(AsteriskComponent, {
      ownerState,
      "aria-hidden": true,
...
var InputLabel = React10.forwardRef(function InputLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime11.jsx)(InputLabelRoot, _extends({
    "data-shrink": shrink,
    ownerState,
    ref,
    className: clsx_default(classes.root, className)
...
var _excluded9 = ["children", "className", "color", "component", "disabled", "error", "focused", "fullWidth", "hiddenLabel", "margin", "required", "size", "variant"];
...
var FormControl = React11.forwardRef(function FormControl2(inProps, ref) {
  ...
  return (0, import_jsx_runtime12.jsx)(FormControlContext_default.Provider, {
    value: childContext,
    children: (0, import_jsx_runtime12.jsx)(FormControlRoot, _extends({
      as: component,
      ownerState,
      className: clsx_default(classes.root, className),
      ref
...
var _span2;
var _excluded10 = ["children", "className", "component", "disabled", "error", "filled", "focused", "margin", "required", "variant"];
...
var _excluded14 = ["autoComplete", "autoFocus", "children", "className", "color", "defaultValue", "disabled", "error", "FormHelperTextProps", "fullWidth", "helperText", "id", "InputLabelProps", "inputProps", "InputProps", "inputRef", "label", "maxRows", "minRows", "multiline", "name", "onBlur", "onChange", "onFocus", "placeholder", "required", "rows", "select", "SelectProps", "type", "value", "variant"];
...
//# sourceMappingURL=chunk-LZ3VN6WE.js.map
