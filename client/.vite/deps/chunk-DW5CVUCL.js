...
var Modal = React7.forwardRef(function Modal2(inProps, ref) {
  ...
  return (0, import_jsx_runtime8.jsx)(Portal_default, {
    ...
    container,
    disablePortal,
    children: (0, import_jsx_runtime9.jsxs)(RootSlot, _extends({}, rootProps, {
      children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime8.jsx)(BackdropSlot, _extends({}, backdropProps)) : null, (0, import_jsx_runtime8.jsx)(FocusTrap_default, {
        disableEnforceFocus,
        disableAutoFocus,
        disableRestoreFocus,
...
var Paper = React8.forwardRef(function Paper2(inProps, ref) {
  ...
  return (0, import_jsx_runtime10.jsx)(PaperRoot, _extends({
    as: component,
    ownerState,
    className: clsx_default(classes.root, className),
    ref
...
var Popover = React9.forwardRef(function Popover2(inProps, ref) {
  ...
  return (0, import_jsx_runtime11.jsx)(RootSlot, _extends({}, rootProps, !isHostComponent_default(RootSlot) && {
    slotProps: rootSlotPropsProp,
    disableScrollLock
  }, {
    children: (0, import_jsx_runtime11.jsx)(TransitionComponent, _extends({
      ...
      children: (0, import_jsx_runtime11.jsx)(PaperSlot, _extends({}, paperProps, {
        children
      }))
    }))
  }));
...
var Menu = React10.forwardRef(function Menu2(inProps, ref) {
  ...
  return (0, import_jsx_runtime12.jsx)(MenuRoot, _extends({
    onClose,
    anchorOrigin: {
      vertical: "bottom",
    ...
    children: (0, import_jsx_runtime12.jsx)(MenuMenuList, _extends({
...
//# sourceMappingURL=chunk-DW5CVUCL.js.map
